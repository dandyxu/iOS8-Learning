...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = NSURL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyCHl3ZdVVnD5Fvl3GMqPK2UXmUwdZF6PCU")
                        ...
                        for item in items {
                            ...
                            if let title = item["title"] as? String {
                                ...
                                if let content = item["content"] as? String{
                                    ...
                                    var newPosts: NSManagedObject = NSEntityDescription.insertNewObjectForEntityForName("Posts", inManagedObjectContext: context) as! NSManagedObject
